            ...
            <div class="row">
                <div class="col-md-5 pr-md-1">
                    <div class="form-group">
                        ...
                        <input type="text" name="txtIdade" required class="form-control" placeholder="Data de lançamento" value="${obj.dataLanc}">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-5 pr-md-1">
                    <div class="form-group">
                        ...
                        <select class="form-control">
                            <c:forEach items="${listaAutor}" var="objCartao">
            ...
            <div class="row">
                <div class="col-md-5 pr-md-1">
                    <div class="form-group">
                        <label>Editora</label>
                        <select class="form-control">
                            <c:forEach items="${listaEditora}" var="objEditora">
            ...
            <div class="row">
                <div class="col-md-5 pr-md-1">
                    <div class="form-group">
                        <label>Editora</label>
                        <select class="form-control">
                            <c:forEach items="${listaClassificacao}" var="objClassificacao">
                                <option value="${objClassificacao.id}" ${obj.classificacao.equals(objClassificacao)?'selected':''}> ${objClassificacao.classificacao}</option>
                            </c:forEach>
                        </select>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-5 pr-md-1">
                    <div class="form-group">
                        <label>Gênero</label>
                        <select class="form-control">
                            <c:forEach items="${listaGenero}" var="objGenero">
